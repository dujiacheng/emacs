(custom-set-variables
 ...
 '(package-selected-packages
   '(doom-themes doom-theme doom-one popper magit monokai-theme monoka monokai pyim wgrep embark-consult cosult consult embark orderless marginalia maginalia vertico keycast company))
